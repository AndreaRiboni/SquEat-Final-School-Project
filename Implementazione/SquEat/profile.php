...
<?php
$conn = connect();
$orders = $conn->query("select Costo, Prodotto.Nome as Prodotto, Locale.Nome as Locale, Ordine.IDOrdine as IDOrdine from Ordine, Prodotto, Locale where IDCliente = ".$_SESSION['id']." and Prodotto.ID = Ordine.IDProdotto and Ordine.IDLocale = Locale.ID order by IDOrdine desc;");
//select Costo, Prodotto.nome, Locale.Nome from Ordine, Prodotto, Locale where IDCliente = 1 and Prodotto.ID = Ordine.IDProdotto and Ordine.IDLocale = Locale.ID;
